...
const exact:Record<string,string>={
  ...
  "THỰC THI VÀ BÁO CÁO":"EXECUTION & REPORTING",
  "CẤU HÌNH":"CONFIGURATION",
  "Dashboard điều hành":"Executive Dashboard",
  "Lập kế hoạch từng bước":"Step-by-step Planning",
  "Cảnh báo kế hoạch":"Planning Alerts",
  "Kế hoạch 7 ngày":"7-day Plan",
  "KPI quản lý":"Management KPI",
  "Việc cần xử lý":"Action Center",
  "Rủi ro giao hàng":"Delivery Risk",
  "Họp sản xuất đầu ca":"Daily Production Meeting",
  "So sánh phương án":"Scenario Comparison",
  "Logic vận hành ERP":"ERP Operating Logic",
  "Kịch bản demo":"Demo Scenario",
  "Truy xuất sản xuất":"Production Traceability",
  "Tạo đơn hàng":"Create Order",
  "Theo dõi Đơn Hàng":"Order Tracking",
  "Lệnh sản xuất":"Production Orders",
  "Lô sản xuất":"Production Lots",
  "Sẵn sàng vật tư":"Material Readiness",
  "Sẵn sàng đủ bộ":"Set Readiness",
  "Phân tích nút thắt":"Bottleneck Analysis",
  "Kế hoạch thông minh":"Smart Planning",
  "Bảng lịch sản xuất":"Production Schedule Board",
  "Điều độ sản xuất":"Production Dispatch",
  "Màn hình xưởng":"Shop Floor",
  "Chất lượng / Hold":"Quality / Hold",
  "Báo cáo sản xuất":"Production Report",
  "Sẵn sàng giao hàng":"Shipping Readiness",
  "Tổn thất sản xuất":"Production Loss",
  "Năng lực công đoạn":"Operation Capacity",
  "Priority theo WO":"WO Priority",
  "Danh mục":"Catalogs",
  "Cấu hình sản xuất":"Production Configuration",
  "NHÀ MÁY":"PLANT",
  "Cửa thép - Demo Plant":"Steel Door - Demo Plant",
  "Hệ thống hoạt động":"System operational",
  "Hệ thống online":"System online",
  "Quản lý & kế hoạch sản xuất":"Production Management & Planning",
  "Kế hoạch sản xuất":"Production Planning",
  "ERP / Quản lý sản xuất":"ERP / Production Management",
  "ERP Sản xuất":"Production ERP",
  "Mở menu":"Open menu",
  ...
  "Nháp":"Draft",
  "Thiếu vật tư":"Material Shortage",
  "Sẵn sàng":"Ready",
  "Đang chờ":"Waiting",
  "Quá tải":"Overload",
  "Nút thắt":"Bottleneck",
  ...
  "Mở màn hình ↗":"Open screen ↗",
  "Dùng dữ liệu tháng 08/2026 để kể câu chuyện nhu cầu → kế hoạch → xưởng → chất lượng.":"Use August 2026 demo data to tell the story from demand → planning → shop floor → quality.",
  "Guided ERP Demo":"Guided ERP Demo",
  "Không ghi database, không Release Dispatch.":"Does not write to the database or Release Dispatch.",
  "Chỉ là simulation, không thay đổi dữ liệu thật.":"Simulation only; real data is not changed.",
  "Mô phỏng trước khi đổi kế hoạch thật.":"Simulate before changing the real plan.",
  "Tổng hợp tình hình sản xuất theo thời gian thực":"Real-time production overview",
  "ERP phát hiện các điểm cần priority":"ERP detects items requiring priority",
  "Xem tất cả →":"View all →",
  "Mở Smart Planning →":"Open Smart Planning →",
  "Tổng số lượng (Bộ)":"Total quantity (Sets)",
  "Tổng nhu cầu production":"Total production demand",
  "Mới / Chưa LSX":"New / No Production Order",
  "Tổng đơn trong hệ thống":"Total orders in the system",
  "Cơ cấu tình trạng đơn hàng":"Order status breakdown",
  "Số LSX con đang chạy và đã hoàn thành theo nhánh":"Running and completed child production orders by branch",
  "NÚT THẮT HÔM NAY":"TODAY'S BOTTLENECK",
  "CAPACITY HIỆU DỤNG":"EFFECTIVE CAPACITY",
  "ĐÃ ĐIỀU ĐỘ":"DISPATCHED",
  ...
  "Hiệu dụng":"Effective",
  "Đã điều độ":"Dispatched",
  "Hàn Cánh":"Door Leaf Welding",
  "Hàn Khung":"Frame Welding",
  "Hàn Phào":"Trim Welding",
  "Laser Cánh":"Door Leaf Laser Cutting",
  "Laser Khung":"Frame Laser Cutting",
  "Laser Phào":"Trim Laser Cutting",
  "Chấn Cánh":"Door Leaf Bending",
  "Chấn Khung":"Frame Bending",
  "Chấn Phào":"Trim Bending",
  "Ép Cánh":"Door Leaf Pressing",
  "Vệ sinh trước sơn":"Pre-paint Cleaning",
  "Dán vân":"Wood-grain Lamination",
  "Lắp ráp / Đóng gói":"Assembly / Packing",
  "Nhập kho":"Warehouse Receipt",
  "Xuất kho":"Shipping",
  "Không có lô trễ hạn":"No late lots",
  "Không có đơn trễ hạn":"No late orders",
  "Sẵn sàng WO14":"Ready for WO14",
  "Đơn đã hoàn thành":"Completed orders",
  "Tổng đơn":"Total orders",
  "Tổng số lượng":"Total quantity",
  "Chưa LSX":"No Production Order",
  "Đang chạy":"Running",
  "Capacity hiệu dụng":"Effective capacity",
  "Mức tải":"Load",
  "Khách hàng":"Customer",
  ...
  "Ngày điều độ":"Dispatch date",
  "Ngày kế hoạch":"Plan date",
  "Ngày sản xuất":"Production date",
  "Ngày giao hàng":"Delivery date",
  "Chưa xử lý":"Pending",
  "Đã xử lý":"Resolved",
  "Đang xử lý":"In progress",
  "Cần ưu tiên":"Priority required",
  "Ưu tiên xử lý":"Prioritize",
  "Không có cảnh báo":"No alerts",
  "Không có cảnh báo kế hoạch":"No planning alerts",
  "Chưa có LSX":"No production order",
  "Đã có LSX":"Production order created",
  "Chưa tạo LSX":"Production order not created",
  "Đã tạo LSX":"Production order created",
  "Chưa tạo Draft":"Draft not created",
  "Đã Release":"Released",
  "Chưa Release":"Not released",
  "Thiếu WIP":"Low WIP",
  "Vượt WIP":"WIP above maximum",
  "Trong giới hạn":"Within limits",
  "Luồng đủ bộ":"Complete-set flow",
  "Nhánh riêng":"Independent branch",
  "Điểm hội tụ":"Merge point",
  "Đủ điều kiện":"Eligible",
  "Không đủ điều kiện":"Not eligible",
  "Đã báo cáo":"Reported",
  "Chưa báo cáo":"Not reported",
  "Còn dư":"Remaining",
  "Chuyển ngày sau":"Carry over to next day",
  "Carry Over ngày trước":"Previous-day carry over",
  ...
  "Tải Capacity theo WO hôm nay":"Today's capacity load by WO",
  "Nhu cầu theo ngày giao (10 ngày tới)":"Demand by delivery date (next 10 days)",
  "Đơn hàng cần chú ý":"Orders requiring attention",
  "Trung tâm điều hành":"Production Control Tower",
  "Nhu cầu vật tư":"Material Requirements",
  "Matching đủ bộ":"Set Matching",
  "Nhu cầu & thiếu hụt vật tư":"Material Requirements & Shortage Planning",
  "Matching Cánh • Khung • Phào theo cấu hình":"Configuration-based Door Leaf • Frame • Trim Matching",
  "Trung tâm điều hành sản xuất":"Production Control Tower",
  "Việc cần xử lý ngay":"Immediate Actions",
  "Top Delivery Risk":"Top Delivery Risk",
  "Capacity Pressure":"Capacity Pressure",
  "Set / Bottleneck":"Set / Bottleneck",
  "Material Pressure":"Material Pressure",
  "Đơn bị ảnh hưởng":"Impacted Orders",
  "Tổng thiếu hụt":"Total Shortage",
  "Tổng nhu cầu":"Total Demand",
  "Tính lại Readiness":"Recalculate Readiness",
  "Điều chỉnh tồn":"Adjust Inventory",
  "Đơn hàng / LSX và BOM Requirement":"Orders / Production Orders & BOM Requirements",
  "Ngoại lệ cần xử lý":"Actionable Exceptions",
  "Capacity Pressure hôm nay":"Today's Capacity Pressure",
  "Vật tư thiếu ảnh hưởng trực tiếp kế hoạch":"Material shortages directly impact the plan",
  "Chỉ hiện LSX còn Set Gap":"Show only production orders with Set Gap",
  "LSX bị chặn":"Blocked Production Orders",
  "Lô đang theo dõi":"Monitored Lots",
  "Set Readiness theo Lô":"Set Readiness by Lot",
  "LSX cần cân bằng đủ bộ":"Production Orders Requiring Set Balancing",
  "WO đang chặn":"Blocking WO",
  "Cap còn":"Remaining Capacity",
  "ETA":"ETA",
  "Không đủ Capacity":"Insufficient Capacity",
  "Đã cân bằng":"Balanced",
  "Bottleneck theo Lô":"Bottleneck by Lot",
  "LSX nên ưu tiên để tháo Bottleneck":"Production Orders to Prioritize for Bottleneck Relief",
  "SL đề xuất":"Recommended Qty",
  "Lý do":"Reason",
  "Hành động":"Action",
  "Giải thích số lượng Auto Dispatch":"Auto Dispatch Quantity Explanation",
  "Capacity ngày":"Daily Capacity",
  "WIP thiếu Target":"WIP Gap to Target",
  "Carry Over":"Carry Over",
  "Set Synchronization":"Set Synchronization",
  "Constraint Management":"Constraint Management",
  "High trước, sau đó Medium":"High priority first, then Medium",
  "Mở Control Tower →":"Open Control Tower →",
  "Xem một luồng ngoại lệ duy nhất: Delivery → Material → Set/Bottleneck → Capacity/WIP → Quality.":"View one unified exception flow: Delivery → Material → Set/Bottleneck → Capacity/WIP → Quality.",
  "Chỉ hiển thị ngoại lệ cần hành động theo một thứ tự duy nhất: Delivery → Material → Set/Bottleneck → Capacity/WIP → Quality.":"Show only actionable exceptions in one sequence: Delivery → Material → Set/Bottleneck → Capacity/WIP → Quality.",
  "Card không lặp ý; mỗi card drill-down về đúng module xử lý.":"No duplicate cards; each card drills down to the correct action module.",
  "Không chỉ nhìn Gap: hệ thống chỉ ra nhánh thiếu, WO đang chặn và khả năng hoàn tất theo Capacity hiện tại.":"Beyond the gap, the system identifies the missing branch, blocking WO, and completion outlook based on current capacity.",
  "Không cộng chéo giữa các đơn.":"No cross-order matching.",
  "Không đề xuất vượt Capacity còn lại":"Recommendations never exceed remaining capacity",
  "Một luồng phân tích duy nhất: Set Gap → nhánh thiếu → WO đang tải cao → đề xuất LSX cần ưu tiên.":"One analysis flow: Set Gap → missing branch → constrained WO → production orders to prioritize."
};
